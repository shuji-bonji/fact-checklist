...
export const translations: TranslationKeys = {
  ...
  pages: {
    home: {
      title: '팩트 체크리스트 - 정보 신뢰성의 평가',
      description:
        '20개 체크 항목으로 정보의 신뢰성을 체계적으로 평가하세요. AI나 정부에 의존하지 않고 자신의 눈과 머리로 정보를 판단하세요.',
      keywords: '팩트체크,정보 검증,신뢰성 평가,PWA,정보 리터러시,가짜정보 대응'
    },
    about: {
      title: '이 앱에 대해 - 팩트 체크리스트',
      description:
        '팩트 체크리스트의 개발 배경, 기능, 사용법에 대해 알아보세요. 정보의 신뢰성을 스스로 판단하기 위한 도구입니다.',
      keywords: '앱 개요,개발 철학,정보 평가,신뢰성 판단,팩트체크,사용법'
    },
    help: {
      title: '도움말 및 가이드 - 팩트 체크리스트',
      description:
        '자세한 사용 지침, 체크리스트 항목 설명, 효과적인 정보 평가를 위한 팁을 제공합니다.',
      keywords: '사용법,도움말,체크 항목,정보 평가,가이드,지침'
    },
    privacy: {
      title: '개인정보처리방침 - 팩트 체크리스트',
      description:
        '개인 데이터 처리에 대한 정보입니다. 모든 데이터는 로컬에 저장되며 외부로 전송되지 않습니다.',
  ...
  intro: {
    meta: {
      title: '허위정보로 가득한 세상에서 살아남기 위한 팩트체크 체크리스트',
      keywords: '팩트체크,정보 검증,신뢰성 평가,PWA,정보 리터러시,허위정보 대응'
    },
    hero: {
      title: '허위정보로 가득한 세상에서 살아남기 위한 팩트체크 체크리스트',
      subtitle:
        '정부 SNS 규제가 진행되는 가운데 자신의 눈과 마음으로 정보의 신뢰성을 평가하기 위한 간단한 체크리스트'
    },
    cta: {
    ...
    sections: {
      ...
      balance: {
        ...
        conclusion:
          '규제에 의존하기보다는 각 개인이 정보를 분별하는 능력을 개발하는 것이 건강한 사회의 기초를 형성합니다.'
      },
      aiLimitations: {
        title: 'AI 팩트체크의 한계',
        ...
        point3:
          '권위에 대한 과도한 의존: 주류 언론과 정부 기관의 정보를 비판 없이 "올바르다"고 판단합니다',
