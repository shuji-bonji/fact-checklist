...
export const translations: TranslationKeys = {
  ...
  pages: {
    ...
    about: {
      ...
      description:
        'Conheça o contexto de desenvolvimento, recursos e uso do Fact Checklist. Uma ferramenta para julgar a confiabilidade das informações por você mesmo.',
      keywords:
        'visão geral do app,filosofia de desenvolvimento,avaliação de informações,julgamento de confiabilidade,verificação de fatos,como usar'
    },
    help: {
      title: 'Ajuda e Guia - Fact Checklist',
      description:
        'Instruções detalhadas de uso, explicações dos itens da lista de verificação e dicas para avaliação efetiva de informações.',
    ...
    privacy: {
      ...
      description:
        'Informações sobre o manuseio de dados pessoais. Todos os dados são armazenados localmente e não são transmitidos externamente.',
  ...
  checklist: {
    ...
    defaultFileName: 'Lista de Verificação',
    ...
    confidenceVeryLow: 'Confiança Muito Baixa',
    judgmentAdviceAccept: 'Adoção recomendada. Verificação suficiente foi conduzida.',
    judgmentAdviceCaution:
      'Verificação adicional recomendada. Seja cauteloso com decisões importantes.',
    judgmentAdviceReject: 'Rejeição recomendada. Procure fontes mais confiáveis.',
    ...
    pwaBenefits: {
      ...
      notifications: '🔔 Notificações (Em breve)'
    },
    pwaInstallButton: '📲 Instalar',
    pwaInstalling: 'Instalando...',
    pwaInstallSuccess: '🎉 Instalação concluída!',
    pwaInstallSuccessMessage: 'O aplicativo foi adicionado à sua tela inicial.',
    pwaLater: 'Mais tarde',
    pwaClose: 'Fechar',
    pwaHint: '💡 Dica',
    pwaFeature: '📱 Suporte para aplicativo PWA',
    pwaPersistent: '📲 Instalar aplicativo',
    pwaHintMessage: 'Instale o aplicativo para uma melhor experiência',
    pwaFeatureMessage: 'Este site está disponível como um Progressive Web App',
    pwaPersistentMessage: 'Instale o aplicativo para uma experiência mais confortável'
  },
  categories: {
    critical: {
  ...
  export: {
    ...
    summary: {
      ...
      confidenceText: 'Texto de Confiança',
      judgmentAdvice: 'Conselho de Julgamento'
    },
    clipboardTitle: 'Resultados de Avaliação de Verificação de Fatos',
    sectionCompletion: 'Taxa de Conclusão por Seção',
    notes: 'Notas de Avaliação',
    judgment: {
      accept: 'Recomendado',
      caution: 'Caução Necessária',
    ...
    error: {
      pdfGeneration: 'Falha na geração de PDF'
    }
  },
  history: {
  ...
  intro: {
    ...
    sections: {
      ...
      balance: {
        ...
        control: {
          ...
          content:
            'Determinação arbitrária da "verdade" pelo poder, supressão de opiniões diversas, impedimento à inovação'
        },
        quality: {
          title: 'Melhoria da Qualidade',
          content:
            'Melhorar a alfabetização informacional individual, fomentar o pensamento crítico, fortalecer as habilidades de autojulgamento'
        },
        conclusion:
          'Em vez de depender de regulamentações, ter cada pessoa desenvolvendo a capacidade de discernir informações forma a base de uma sociedade saudável.'
      },
      aiLimitations: {
        ...
        point1:
          'Viés dos dados de treinamento: A IA reflete vieses inerentes em seus dados de treinamento',
        point2:
          'Compreensão incompleta do contexto: Interpreta mal nuances sutis, sarcasmo e contextos culturais',
        point3:
          'Dependência excessiva de autoridade: Julga acriticamente informações da mídia tradicional e agências governamentais como "corretas"',
        conclusion:
          'Embora a IA possa ser útil como referência, julgamentos finais devem ser feitos por humanos.'
      },
      features: {
    ...
    features: {
      systematic: {
        title: 'Avaliação Sistemática',
        description:
          'Avaliação abrangente desde fontes de informação até estrutura lógica com uma lista de verificação de 20 itens'
      },
      privacy: {
        title: 'Privacidade Completa',
        description:
          'Todos os dados armazenados no dispositivo. Nenhuma transmissão para servidores externos'
      },
      pwa: {
    ...
    share: {
      ...
      description: 'Resultado de avaliação de confiabilidade da informação',
      invalidUrl: 'URL de compartilhamento inválida',
      sharedChecklist: 'Lista de Verificação Compartilhada',
      loadError: 'Falha ao carregar dados compartilhados',
      saveError: 'Falha ao salvar lista de verificação',
      sharedResultTitle: 'Resultado de Avaliação Compartilhado',
      sharedResultDescription:
        'Este resultado foi carregado de um link compartilhado (somente leitura)',
