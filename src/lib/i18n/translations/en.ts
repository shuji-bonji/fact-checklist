...
export const translations: TranslationKeys = {
  ...
  checklist: {
    ...
    defaultFileName: 'Checklist Information',
    ...
    pwaInstallTitle: '🎉 Evaluation complete! Would you like to install the app?',
    pwaInstallMessage: 'Why not install this application so that you can quickly evaluate information at any time?',
    pwaBenefits: {
  ...
  export: {
    ...
    pdfMode: 'PDF Generation Mode',
    pdfModes: {
      pixelPerfect: 'Pixel Perfect',
      pixelPerfectDescription: 'Exact browser display match',
      reliableFont: 'Font Reliability Focus',
      reliableFontDescription: 'Reliable multilingual font embedding',
      textBased: 'Text Based',
      textBasedDescription: 'Searchable lightweight PDF'
    },
    formats: {
      pdf: 'PDF',
      html: 'HTML',
