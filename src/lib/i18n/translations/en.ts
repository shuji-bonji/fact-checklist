...
export const translations: TranslationKeys = {
  ...
  pages: {
    home: {
      ...
      description: 'Systematically evaluate information reliability with 20 checklist items. Judge information with your own eyes and mind without relying on AI or government.',
      keywords: 'fact-checking,information verification,reliability assessment,PWA,information literacy,misinformation countermeasures'
    },
    about: {
      title: 'About This App - Fact Checklist',
      description: 'Learn about the development background, features, and usage of Fact Checklist. A tool for judging information reliability yourself.',
      keywords: 'app overview,development philosophy,information evaluation,reliability judgment,fact-checking,how to use'
    },
    help: {
      title: 'Help & Guide - Fact Checklist',
      description: 'Detailed usage instructions, checklist item explanations, and tips for effective information evaluation.',
      keywords: 'how to use,help,checklist items,information evaluation,guide,instructions'
    },
    privacy: {
      title: 'Privacy Policy - Fact Checklist',
      description: 'Information about personal data handling. All data is stored locally and not transmitted externally.',
    ...
    intro: {
      ...
      description: 'A simple checklist to evaluate information reliability with your own eyes and mind as government SNS regulations advance. Scientifically and systematically evaluate information without blindly trusting AI or media.',
      keywords: 'fact-checking,information verification,reliability assessment,PWA,information literacy,misinformation countermeasures,SNS regulation,information control,information quality,AI fact-checking'
    }
  },
  ...
  intro: {
    meta: {
      title: 'Practical Fact-Check Checklist for Surviving in a World Full of Misinformation',
      keywords: 'fact-checking,fact verification,information verification,reliability assessment,PWA,information literacy,misinformation countermeasures'
    },
    hero: {
      title: 'Practical Fact-Check Checklist for Surviving in a World Full of Misinformation',
      subtitle: 'A simple checklist to evaluate information reliability with your own eyes and mind as government SNS regulations advance'
    },
    cta: {
    ...
    sections: {
      regulation: {
        ...
        content1: 'SNS regulations advancing worldwide claim to be "anti-misinformation measures," but in reality, they risk becoming tools for controlling information inconvenient to governments.',
        content2: 'What we need is the ability to judge information reliability ourselves, without relying on governments, mainstream media, or AI.'
      },
      balance: {
        title: 'Speech Control vs. Information Quality: A Balanced Approach',
        control: {
          title: 'Risks of Control',
          content: 'Arbitrary determination of "truth" by power, suppression of diverse opinions, hindrance to innovation'
        },
        quality: {
          title: 'Quality Improvement',
          content: 'Improving individual information literacy, fostering critical thinking, strengthening self-judgment abilities'
        },
        conclusion: 'Rather than relying on regulations, having each person develop the ability to discern information forms the foundation of a healthy society.'
      },
      aiLimitations: {
        ...
        point2: 'Incomplete context understanding: Misinterprets subtle nuances, sarcasm, and cultural contexts',
        point3: 'Over-reliance on authority: Uncritically judges information from mainstream media and government agencies as "correct"',
        conclusion: 'While AI can be helpful for reference, final judgments should be made by humans.'
      },
      features: {
    ...
    features: {
      systematic: {
        title: 'Systematic Evaluation',
        description: 'Comprehensive assessment from information sources to logical structure with a 20-item checklist'
      },
      privacy: {
