...
export const translations: TranslationKeys = {
  ...
  pages: {
    home: {
      ...
      description: '20 चेक आइटम के साथ जानकारी की विश्वसनीयता का व्यवस्थित मूल्यांकन करें। AI या सरकार पर निर्भर हुए बिना अपनी आंखों और दिमाग से जानकारी का न्याय करें।',
      keywords: 'तथ्य-जांच,जानकारी सत्यापन,विश्वसनीयता मूल्यांकन,PWA,सूचना साक्षरता,गलत जानकारी के प्रतिकार'
    },
    about: {
      title: 'इस ऐप के बारे में - तथ्य चेकलिस्ट',
      description: 'तथ्य चेकलिस्ट के विकास पृष्ठभूमि, सुविधाओं और उपयोग के बारे में जानें। जानकारी की विश्वसनीयता का स्वयं न्याय करने का एक उपकरण।',
      keywords: 'ऐप अवलोकन,विकास दर्शन,जानकारी मूल्यांकन,विश्वसनीयता निर्णय,तथ्य-जांच,उपयोग कैसे करें'
    },
    help: {
      title: 'सहायता और गाइड - तथ्य चेकलिस्ट',
      description: 'विस्तृत उपयोग निर्देश, चेकलिस्ट आइटम स्पष्टीकरण, और प्रभावी जानकारी मूल्यांकन के लिए सुझाव।',
      keywords: 'उपयोग कैसे करें,सहायता,चेक आइटम,जानकारी मूल्यांकन,गाइड,निर्देश'
    },
    privacy: {
      title: 'गोपनीयता नीति - तथ्य चेकलिस्ट',
      description: 'व्यक्तिगत डेटा हैंडलिंग के बारे में जानकारी। सभी डेटा स्थानीय रूप से संग्रहीत है और बाहरी रूप से प्रसारित नहीं किया जाता।',
    ...
    intro: {
      ...
      description: 'सरकारी सोशल मीडिया नियमन के आगे बढ़ने के दौरान अपनी आंखों और दिमाग से जानकारी की विश्वसनीयता का मूल्यांकन करने के लिए एक सरल चेकलिस्ट। AI या मीडिया पर अंधा भरोसा किए बिना वैज्ञानिक और व्यवस्थित रूप से जानकारी का मूल्यांकन करें।',
      keywords: 'तथ्य-जांच,जानकारी सत्यापन,विश्वसनीयता मूल्यांकन,PWA,सूचना साक्षरता,गलत जानकारी के प्रतिकार,सोशल मीडिया नियमन,जानकारी नियंत्रण,जानकारी की गुणवत्ता,AI तथ्य-जांच'
    }
  },
  ...
  intro: {
    meta: {
      ...
      keywords: 'तथ्य-जाँच,जानकारी सत्यापन,विश्वसनीयता मूल्यांकन,PWA,सूचना साक्षरता,गलत जानकारी रोकथाम'
    },
    hero: {
      title: 'गलत जानकारी से भरी दुनिया में जीवित रहने के लिए प्रायोगिक तथ्य-जाँच चेकलिस्ट',
      subtitle: 'सरकारी सोशल मीडिया नियमों के बढ़ने के साथ अपनी आँखों और दिमाग से जानकारी की विश्वसनीयता का मूल्यांकन करने के लिए एक सरल चेकलिस्ट'
    },
    cta: {
    ...
    sections: {
      regulation: {
        ...
        content1: 'दुनिया भर में बढ़ रहे सोशल मीडिया नियम "गलत जानकारी विरोधी उपाय" होने का दावा करते हैं, लेकिन वास्तव में, वे सरकारों के लिए असुविधाजनक जानकारी को नियंत्रित करने के उपकरण बनने का जोखिम रखते हैं।',
        content2: 'हमें सरकारों, मुख्यधारा मीडिया, या AI पर निर्भर रहे बिना, स्वयं जानकारी की विश्वसनीयता का न्याय करने की क्षमता की आवश्यकता है।'
      },
      balance: {
        ...
        quality: {
          ...
          content: 'व्यक्तिगत सूचना साक्षरता में सुधार, आलोचनात्मक सोच को बढ़ावा देना, स्व-निर्णय क्षमताओं को मजबूत करना'
        },
        conclusion: 'नियमों पर निर्भर रहने के बजाय, हर व्यक्ति में जानकारी को पहचानने की क्षमता विकसित करना एक स्वस्थ समाज की नींव बनाता है।'
      },
      aiLimitations: {
        ...
        point1: 'प्रशिक्षण डेटा पूर्वाग्रह: AI अपने प्रशिक्षण डेटा में निहित पूर्वाग्रहों को प्रतिबिंबित करता है',
        point2: 'अपूर्ण संदर्भ समझ: सूक्ष्म बारीकियों, व्यंग्य, और सांस्कृतिक संदर्भों की गलत व्याख्या',
        point3: 'अधिकार पर अत्यधिक निर्भरता: मुख्यधारा मीडिया और सरकारी एजेंसियों की जानकारी को बिना आलोचना के "सही" मानना',
        conclusion: 'जबकि AI संदर्भ के लिए सहायक हो सकता है, अंतिम निर्णय मनुष्यों द्वारा लिए जाने चाहिए।'
      },
      features: {
    ...
    features: {
      systematic: {
        title: 'व्यवस्थित मूल्यांकन',
        description: '20-आइटम चेकलिस्ट के साथ जानकारी के स्रोतों से तार्किक संरचना तक व्यापक मूल्यांकन'
      },
      privacy: {
