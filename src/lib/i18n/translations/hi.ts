...
export const translations: TranslationKeys = {
  ...
  app: {
    ...
    brandTitle: 'तथ्य चेकलिस्ट',
    brandSubtitle: 'जानकारी की विश्वसनीयता का व्यवस्थित मूल्यांकन',
    description: 'जानकारी की विश्वसनीयता का वैज्ञानिक और व्यवस्थित मूल्यांकन के लिए एक चेकलिस्ट',
    version: '1.0.0',
    author: 'तथ्य चेकलिस्ट टीम',
    copyright: '© 2025 तथ्य चेकलिस्ट टीम',
    poweredBy: 'द्वारा संचालित'
  },

  // पेज-विशिष्ट मेटाडेटा
  pages: {
    home: {
      title: 'तथ्य चेकलिस्ट - जानकारी की विश्वसनीयता का मूल्यांकन',
      description:
        '20 चेक आइटम के साथ जानकारी की विश्वसनीयता का व्यवस्थित मूल्यांकन करें। AI या सरकार पर निर्भर हुए बिना अपनी आंखों और दिमाग से जानकारी का न्याय करें।',
      keywords:
        'तथ्य-जांच,जानकारी सत्यापन,विश्वसनीयता मूल्यांकन,PWA,सूचना साक्षरता,गलत जानकारी के प्रतिकार'
    },
    about: {
      title: 'इस ऐप के बारे में - तथ्य चेकलिस्ट',
      description:
        'तथ्य चेकलिस्ट के विकास पृष्ठभूमि, सुविधाओं और उपयोग के बारे में जानें। जानकारी की विश्वसनीयता का स्वयं न्याय करने का एक उपकरण।',
      keywords:
        'ऐप अवलोकन,विकास दर्शन,जानकारी मूल्यांकन,विश्वसनीयता निर्णय,तथ्य-जांच,उपयोग कैसे करें'
    },
    help: {
      title: 'सहायता और गाइड - तथ्य चेकलिस्ट',
      description:
        'विस्तृत उपयोग निर्देश, चेकलिस्ट आइटम स्पष्टीकरण, और प्रभावी जानकारी मूल्यांकन के लिए सुझाव।',
      keywords: 'उपयोग कैसे करें,सहायता,चेक आइटम,जानकारी मूल्यांकन,गाइड,निर्देश'
    },
    privacy: {
      title: 'गोपनीयता नीति - तथ्य चेकलिस्ट',
      description:
        'व्यक्तिगत डेटा हैंडलिंग के बारे में जानकारी। सभी डेटा स्थानीय रूप से संग्रहीत है और बाहरी रूप से प्रसारित नहीं किया जाता।',
      keywords: 'गोपनीयता,व्यक्तिगत जानकारी,डेटा सुरक्षा,स्थानीय भंडारण,सुरक्षा'
    },
    intro: {
      title: 'गलत जानकारी से भरी दुनिया में जीवित रहने के लिए तथ्य चेकलिस्ट',
      description:
        'सरकारी सोशल मीडिया नियमन के आगे बढ़ने के दौरान अपनी आंखों और दिमाग से जानकारी की विश्वसनीयता का मूल्यांकन करने के लिए एक सरल चेकलिस्ट। AI या मीडिया पर अंधा भरोसा किए बिना वैज्ञानिक और व्यवस्थित रूप से जानकारी का मूल्यांकन करें।',
      keywords:
        'तथ्य-जांच,जानकारी सत्यापन,विश्वसनीयता मूल्यांकन,PWA,सूचना साक्षरता,गलत जानकारी के प्रतिकार,सोशल मीडिया नियमन,जानकारी नियंत्रण,जानकारी की गुणवत्ता,AI तथ्य-जांच'
    }
  },
  ...
  checklist: {
    ...
    confidenceVeryHigh: 'अत्यधिक उच्च विश्वास',
    confidenceHigh: 'उच्च विश्वास',
    confidenceMedium: 'मध्यम विश्वास',
    confidenceLow: 'कम विश्वास',
    confidenceVeryLow: 'अत्यधिक कम विश्वास',
    judgmentAdviceAccept: 'अपनाने की सिफारिश की जाती है। पर्याप्त सत्यापन किया गया है।',
    judgmentAdviceCaution:
      'अतिरिक्त सत्यापन की सिफारिश की जाती है। महत्वपूर्ण निर्णयों के साथ सावधान रहें।',
    judgmentAdviceReject: 'अस्वीकार करने की सिफारिश की जाती है। अधिक विश्वसनीय स्रोत खोजें।',
    ...
    pwaInstallTitle: '🎉 मूल्यांकन पूर्ण! ऐप इंस्टॉल करें?',
    pwaInstallMessage: 'किसी भी समय त्वरित और आसान जानकारी मूल्यांकन के लिए इस ऐप को इंस्टॉल करें।',
    pwaBenefits: {
      fastLaunch: '🚀 तेज़ लॉन्च',
      homeScreen: '📱 होम स्क्रीन से सीधी पहुंच',
      offlineAvailable: '🌐 ऑफलाइन उपलब्ध',
      notifications: '🔔 सूचनाएं (जल्द आ रही हैं)'
    },
    pwaInstallButton: '📲 इंस्टॉल करें',
    pwaInstalling: 'इंस्टॉल हो रहा है...',
    pwaInstallSuccess: '🎉 इंस्टॉलेशन पूर्ण!',
    pwaInstallSuccessMessage: 'ऐप आपकी होम स्क्रीन में जोड़ दिया गया है।',
    pwaLater: 'बाद में',
    pwaClose: 'बंद करें',
    pwaHint: '💡 सुझाव',
    pwaFeature: '📱 PWA ऐप समर्थन',
    pwaPersistent: '📲 ऐप इंस्टॉल करें',
    pwaHintMessage: 'बेहतर अनुभव के लिए ऐप इंस्टॉल करें',
    pwaFeatureMessage: 'यह साइट Progressive Web App के रूप में उपलब्ध है',
    pwaPersistentMessage: 'अधिक आरामदायक अनुभव के लिए ऐप इंस्टॉल करें'
  },
  categories: {
    critical: {
  ...
  export: {
    ...
    summary: {
      ...
      confidenceText: 'विश्वास पाठ',
      judgmentAdvice: 'निर्णय सलाह'
    },
    clipboardTitle: 'तथ्य जांच मूल्यांकन परिणाम',
    sectionCompletion: 'अनुभाग पूर्णता दर',
    notes: 'मूल्यांकन टिप्पणियां',
    judgment: {
      accept: 'सिफारिश की गई',
      caution: 'सावधानी आवश्यक',
      reject: 'सिफारिश नहीं',
      notEvaluated: 'मूल्यांकन नहीं किया'
    },
    csv: {
      id: 'ID',
      title: 'शीर्षक',
    ...
    error: {
      pdfGeneration: 'PDF निर्माण में विफल'
    }
  },
  history: {
    ...
    sections: {
      ...
      features: {
        ...
        subSections: {
          ...
          sharing: {
            title: 'साझाकरण सुविधा',
            content:
              'मूल्यांकन परिणाम आसानी से साझा करें।\n• OS मूल साझाकरण (स्मार्टफोन)\n• सामाजिक मीडिया साझाकरण (X, Facebook, WhatsApp)\n• QR कोड जेनरेशन\n• URL कॉपी\n• ईमेल भेजना\n\n📌 साझा करने का तरीका:\n1. मूल्यांकन पूरा करने के बाद, "साझा करें" बटन पर क्लिक करें\n2. साझाकरण विधि चुनें (OS साझाकरण प्राथमिकता)\n3. URL में संपीड़ित और एन्कोडेड मूल्यांकन डेटा शामिल है\n4. कोई सर्वर आवश्यक नहीं (केवल URL समाधान)'
          },
          pwaSupport: {
            title: 'PWA समर्थन',
  ...
  intro: {
    meta: {
      title: 'गलत जानकारी से भरी दुनिया में जीवित रहने के लिए प्रायोगिक तथ्य-जाँच चेकलिस्ट',
      keywords:
        'तथ्य-जाँच,जानकारी सत्यापन,विश्वसनीयता मूल्यांकन,PWA,सूचना साक्षरता,गलत जानकारी रोकथाम'
    },
    hero: {
      title: 'गलत जानकारी से भरी दुनिया में जीवित रहने के लिए प्रायोगिक तथ्य-जाँच चेकलिस्ट',
      subtitle:
        'सरकारी सोशल मीडिया नियमों के बढ़ने के साथ अपनी आँखों और दिमाग से जानकारी की विश्वसनीयता का मूल्यांकन करने के लिए एक सरल चेकलिस्ट'
    },
    cta: {
      startNow: 'अभी जाँच शुरू करें',
      useChecklist: 'चेकलिस्ट का उपयोग करें',
      learnMore: 'और जानें'
    },
    sections: {
      regulation: {
        title: 'सरकारी सोशल मीडिया नियम और सूचना नियंत्रण की वास्तविकता',
        quote: '"गलत जानकारी हटाने" के नेक कारण के तहत, कौन तय करता है कि "सच" क्या है?',
        content1:
          'दुनिया भर में बढ़ रहे सोशल मीडिया नियम "गलत जानकारी विरोधी उपाय" होने का दावा करते हैं, लेकिन वास्तव में, वे सरकारों के लिए असुविधाजनक जानकारी को नियंत्रित करने के उपकरण बनने का जोखिम रखते हैं।',
        content2:
          'हमें सरकारों, मुख्यधारा मीडिया, या AI पर निर्भर रहे बिना, स्वयं जानकारी की विश्वसनीयता का न्याय करने की क्षमता की आवश्यकता है।'
      },
      balance: {
        title: 'भाषण नियंत्रण बनाम सूचना गुणवत्ता: एक संतुलित दृष्टिकोण',
        control: {
          title: 'नियंत्रण के जोखिम',
          content: 'सत्ता द्वारा "सच" का मनमाना निर्धारण, विविध मतों का दमन, नवाचार में बाधा'
        },
        quality: {
          title: 'गुणवत्ता सुधार',
          content:
            'व्यक्तिगत सूचना साक्षरता में सुधार, आलोचनात्मक सोच को बढ़ावा देना, स्व-निर्णय क्षमताओं को मजबूत करना'
        },
        conclusion:
          'नियमों पर निर्भर रहने के बजाय, हर व्यक्ति में जानकारी को पहचानने की क्षमता विकसित करना एक स्वस्थ समाज की नींव बनाता है।'
      },
      aiLimitations: {
        title: 'AI तथ्य-जाँच की सीमाएँ',
        lead: 'जबकि ChatGPT और Gemini जैसे AI सुविधाजनक हैं, तथ्य-जाँच के लिए उनकी महत्वपूर्ण सीमाएँ हैं:',
        point1:
          'प्रशिक्षण डेटा पूर्वाग्रह: AI अपने प्रशिक्षण डेटा में निहित पूर्वाग्रहों को प्रतिबिंबित करता है',
        point2:
          'अपूर्ण संदर्भ समझ: सूक्ष्म बारीकियों, व्यंग्य, और सांस्कृतिक संदर्भों की गलत व्याख्या',
        point3:
          'अधिकार पर अत्यधिक निर्भरता: मुख्यधारा मीडिया और सरकारी एजेंसियों की जानकारी को बिना आलोचना के "सही" मानना',
        conclusion:
          'जबकि AI संदर्भ के लिए सहायक हो सकता है, अंतिम निर्णय मनुष्यों द्वारा लिए जाने चाहिए।'
      },
      features: {
        title: 'इस ऐप की विशेषताएँ'
      }
    },
    features: {
      systematic: {
        title: 'व्यवस्थित मूल्यांकन',
        description:
          '20-आइटम चेकलिस्ट के साथ जानकारी के स्रोतों से तार्किक संरचना तक व्यापक मूल्यांकन'
      },
      privacy: {
        title: 'पूर्ण गोपनीयता',
        description: 'सभी डेटा डिवाइस पर संग्रहीत। बाहरी सर्वर पर कोई स्थानांतरण नहीं'
      },
      pwa: {
        title: 'ऑफ़लाइन सपोर्ट',
        description: 'PWA तकनीक के कारण बिना इंटरनेट कनेक्शन के भी उपलब्ध'
      },
      multilingual: {
        title: '12 भाषा सपोर्ट',
        description: 'जापानी, अंग्रेजी, और चीनी सहित 12 भाषाओं के लिए पूर्ण समर्थन'
      }
    },
    finalCta: {
      title: 'चलिए अभी शुरू करते हैं',
      subtitle: 'जानकारी के समुद्र में डूबने से बचने के लिए अपने निर्णय को प्रशिक्षित करें'
    },
    share: {
      title: 'इस टूल को साझा करें',
      button: 'साझा करें',
      ...
      score: 'स्कोर: {score}%',
      description: 'जानकारी की विश्वसनीयता मूल्यांकन परिणाम',
      invalidUrl: 'अमान्य साझा URL',
      sharedChecklist: 'साझा की गई चेकलिस्ट',
      loadError: 'साझा डेटा लोड करने में विफल',
      saveError: 'चेकलिस्ट सेव करने में विफल',
      sharedResultTitle: 'साझा किया गया मूल्यांकन परिणाम',
      sharedResultDescription: 'यह परिणाम साझा लिंक से लोड किया गया (केवल पढ़ने के लिए)',
