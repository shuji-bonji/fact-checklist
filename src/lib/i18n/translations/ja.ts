...
export const checklistItems = {
  ...
  'warning-sensational': {
    ...
    guideContent:
      '警告する表現：「絶対に」「完全に」「驚愕の」「衝撃的な」「○○業界が隠す」\n感情誘導：恐怖、怒り、嫉妬を煽る表現\n適切な表現：「研究結果によると」「データが示している」「専門家の見解では」',
    examplesGood: ['研究では75%の被験者に改善が見られた', 'データによると統計的有意差が確認された'],
    examplesBad: ['医師が絶対に教えない驚愕の真実！', '業界が隠蔽する衝撃的事実']
  },
  'warning-logical': {
    title: '論理的な矛盾がない',
  ...
  'scope-clear': {
    ...
    guideContent:
      '明確にすべき範囲：\n• 対象となる人・地域・期間\n• 研究の限界・制約\n• 一般化可能性の程度\n• 除外されるケース\n重要性：過度な一般化や誤用を防ぐため',
    examplesGood: ['日本の成人男性を対象とした研究のため、他の集団への適用は慎重に', '限界の明記'],
    examplesBad: ['限定的な研究結果を無制限に一般化', '適用範囲不明']
  }
};
...
export const judgmentAdvices = {
  ...
  caution: '追加確認を推奨します。重要な決定には慎重に。',
  reject: '不採用を推奨します。信頼できる情報源を探しましょう。',
  lowConfidence: '要注意です。さらなる検証が必要です。'
};
...
export const uiTexts = {
  ...
  placeholders: {
    title: '例: 新型コロナワクチンの効果に関する記事',
    description: '評価対象となる情報の詳細を記入してください...',
    notes: '疑問点、追加で確認したい事項、総合的な印象など、自由に記録してください...'
  },
  defaultTitle: '事実確認チェック_',
  menuToggleAriaLabel: 'メニューを開閉',
  scoreLabels: {
    critical: '🚨 クリティカル',
    detailed: '📝 詳細評価',
    verification: '🔍 検証・照合',
