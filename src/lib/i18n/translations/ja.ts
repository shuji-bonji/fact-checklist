...
export const translations: TranslationKeys = {
  ...
  pages: {
    ...
    about: {
      ...
      description: 'Fact Checklistの開発背景、特徴、使い方について。情報の信頼性を自分で判断するためのツールです。',
      keywords: 'アプリ概要,開発理念,情報評価,信頼性判断,ファクトチェック,使い方'
    },
    help: {
      title: 'ヘルプ・使い方 - Fact Checklist',
      description: 'Fact Checklistの詳しい使い方、チェック項目の説明、効果的な情報評価のコツを解説。',
      keywords: '使い方,ヘルプ,チェック項目,情報評価,ガイド,操作方法'
    },
    privacy: {
      title: 'プライバシーポリシー - Fact Checklist',
      description: '個人情報の取り扱いについて。すべてのデータはローカルに保存され、外部に送信されません。',
  ...
  intro: {
    ...
    hero: {
      title: '偽情報・誤情報だらけの世界を生き抜く、実用的ファクトチェックシート',
      subtitle: '政府のSNS規制が進む中、情報の信頼性を自分の目と頭で見極めるためのシンプルなチェックリスト'
    },
    cta: {
    ...
    sections: {
      regulation: {
        ...
        content1: '世界各国で進むSNS規制は、表向きは「偽情報対策」を掲げていますが、その実態は政府にとって都合の悪い情報を統制する手段になりかねません。',
        content2: '私たちに必要なのは、政府や大手メディア、AIに頼らず、自分自身で情報の信頼性を判断する力です。'
      },
      balance: {
        ...
        conclusion: '規制に頼るのではなく、一人ひとりが情報を見極める力を持つことが、健全な社会の基盤となります。'
      },
      aiLimitations: {
        title: 'AIファクトチェックの限界',
