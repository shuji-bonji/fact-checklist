...
export const translations: TranslationKeys = {
  ...
  pages: {
    home: {
      title: 'Fact Checklist - ファクトチェックリスト',
      description:
        '20項目のチェックリストで情報の信頼性を体系的に評価。AIや政府に頼らず、自分の目と頭で情報を見極めるPWAアプリ。',
      keywords: '事実確認,ファクトチェック,情報検証,信頼性評価,PWA,情報リテラシー,偽情報対策'
    },
    about: {
      title: 'このアプリについて - Fact Checklist',
      description:
        'Fact Checklistの開発背景、特徴、使い方について。情報の信頼性を自分で判断するためのツールです。',
      keywords: 'アプリ概要,開発理念,情報評価,信頼性判断,ファクトチェック,使い方'
    },
    help: {
      title: 'ヘルプ・使い方 - Fact Checklist',
      description:
        'Fact Checklistの詳しい使い方、チェック項目の説明、効果的な情報評価のコツを解説。',
      keywords: '使い方,ヘルプ,チェック項目,情報評価,ガイド,操作方法'
    },
    privacy: {
      title: 'プライバシーポリシー - Fact Checklist',
      description:
        '個人情報の取り扱いについて。すべてのデータはローカルに保存され、外部に送信されません。',
      keywords: 'プライバシー,個人情報,データ保護,ローカルストレージ,セキュリティ'
    },
    intro: {
      title: '偽情報・誤情報だらけの世界を生き抜く、ファクトチェックリスト - Fact Checklist',
      description:
  ...
  privacy: {
    title: 'プライバシーポリシー',
    subtitle:
      'ファクトチェックリストのプライバシーポリシー。データの取り扱いと保護について説明します。',
    lastUpdated: '最終更新: 2025年6月28日',
    introduction: {
      title: '🛡️ プライバシー保護への取り組み',
      content:
        '「ファクトチェックリスト」は、ユーザーのプライバシー保護を最重要課題として位置づけています。このアプリケーションは完全にローカル環境で動作し、サーバーへのデータ送信は一切行いません。'
    },
    dataCollection: {
      title: '📊 データ収集について',
  ...
  about: {
    title: 'アプリについて',
    subtitle: 'ファクトチェックリストの詳細情報とアプリの特徴について',
    hero: {
      title: 'ファクトチェックリスト',
  ...
  intro: {
    meta: {
      title: '偽情報・誤情報だらけの世界を生き抜く、ファクトチェックリスト',
      keywords: '事実確認,ファクトチェック,情報検証,信頼性評価,PWA,情報リテラシー,偽情報対策'
    },
    hero: {
      title: '偽情報・誤情報だらけの世界を生き抜く、ファクトチェックリスト',
    ...
    cta: {
      startNow: '今すぐチェックを始める',
      useChecklist: 'チェックシートを使う',
      learnMore: '詳しく見る'
    },
    sections: {
      regulation: {
        title: '政府のSNS規制と情報統制の現実',
        quote: '「偽情報・誤情報を削除する」という大義名分の下、誰が「真実」を決めるのか？',
        content1:
          '世界各国で進むSNS規制は、表向きは「偽情報対策」を掲げていますが、その実態は政府にとって都合の悪い情報を統制する手段になりかねません。',
        content2:
          '私たちに必要なのは、政府や大手メディア、AIに頼らず、自分自身で情報の信頼性を判断する力です。'
      },
      balance: {
        title: '言論統制vs情報の質：バランスの取れたアプローチ',
        control: {
          title: '統制のリスク',
          content: '権力による恣意的な「真実」の決定、多様な意見の抑圧、イノベーションの阻害'
        },
        quality: {
          title: '質の向上',
          content: '個人の情報リテラシー向上、批判的思考力の育成、自己判断能力の強化'
        },
        conclusion:
          '規制に頼るのではなく、一人ひとりが情報を見極める力を持つことが、健全な社会の基盤となります。'
      },
      aiLimitations: {
        title: 'AIファクトチェックの限界',
        lead: 'ChatGPTやGeminiなどのAIは便利ですが、ファクトチェックには重大な限界があります：',
        point1: '学習データの偏り：AIは訓練データに含まれる偏見をそのまま反映',
        point2: '文脈理解の不完全性：微妙なニュアンスや皮肉、文化的文脈を誤解',
        point3: '権威への過度な依存：大手メディアや政府機関の情報を無批判に「正しい」と判断',
        conclusion: 'AIは参考にはなりますが、最終的な判断は人間が行うべきです。'
      },
      features: {
        title: 'このアプリの特徴'
      }
    ...
    features: {
      systematic: {
        title: '体系的な評価',
        description: '20項目のチェックリストで、情報源から論理構造まで包括的に評価'
      },
      privacy: {
        title: '完全プライベート',
        description: 'すべてのデータは端末内に保存。外部サーバーへの送信は一切なし'
      },
      pwa: {
        title: 'オフライン対応',
        description: 'PWA技術により、ネット環境がなくても利用可能'
      },
      multilingual: {
        title: '12言語対応',
        description: '日本語、英語、中国語など12言語に完全対応'
      }
    },
    finalCta: {
      title: '今すぐ始めよう',
