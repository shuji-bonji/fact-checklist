...
export const translations: TranslationKeys = {
  ...
  pages: {
    home: {
      ...
      description: '透過20個檢查項目系統性評估資訊可靠性。不依賴AI或政府，用自己的眼睛和頭腦判斷資訊。',
    ...
    intro: {
      ...
      description: '在政府社群媒體管制進展中，用自己的眼睛和頭腦評估資訊可靠性的簡單檢查表。科學系統性地評估資訊，不盲目信任AI或媒體。',
      keywords: '事實查核,資訊驗證,可靠性評估,PWA,資訊素養,假訊息對策,社群媒體管制,資訊控制,資訊品質,AI事實查核'
    }
  },
  ...
  intro: {
    ...
    sections: {
      regulation: {
        ...
        content1: '全球正在推進的社交網路規範聲稱是「反虛假資訊措施」，但實際上，它們有成為控制對政府不利資訊工具的風險。',
